  ...
  return (
    <>
      ...
      <button
        ...
        title="Lên đầu trang"
        onClick={scrollToTop}
        className="fixed bottom-6 right-6 z-[100] flex size-11 items-center justify-center rounded-full border border-[#f5f0e8]/30 bg-[#6B1218] text-[#F5F0E8] shadow-lg shadow-black/20 transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#7A1218] hover:text-[#F8F0E4]"
      >
