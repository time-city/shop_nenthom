...
export type ProductDetail = {
  ...
  name: string;
  options?: {
    packagings?: OptionItem[];
    scents?: OptionItem[];
    sizes?: OptionItem[];
    toppings?: OptionItem[];
    waxColors?: OptionItem[];
  };
};

type DetailCardProductProps = {
...
export default function DetailCardProduct({ product, onClose }: DetailCardProductProps) {
              ...
              <div className="flex aspect-square items-center justify-center rounded-xl bg-[#F5F0E8] p-8 shadow-[0_8px_22px_rgba(44,24,16,0.08)]">
                {image ? (
                  ...
                  <div className="relative h-[220px] w-[165px] rounded-[8px_8px_6px_6px] shadow-[0_28px_54px_rgba(44,24,16,0.14),inset_-16px_0_28px_rgba(126,93,56,0.1),inset_12px_0_22px_rgba(255,255,255,0.28)] sm:h-[250px] sm:w-[185px]">
                    <div
                      className="absolute inset-0 rounded-[8px_8px_6px_6px]"
                      style={{
...
type DetailOptionGroupProps = {
  label: string;
  onSelect: (item: OptionItem) => void;
  options: OptionItem[];
  renderLabel?: (item: OptionItem) => string;
  selectedId?: number;
};
