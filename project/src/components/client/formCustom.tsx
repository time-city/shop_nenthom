...
export default function FormCustom({
    ...
    return (
        <section
            id="customize"
            className="page-section fade-section bg-[#6B1218] px-4 py-4 md:py-6 lg:py-8 text-[#F5F0E8] sm:px-6 lg:px-16 min-h-[calc(100vh-80px)] lg:h-[calc(100vh-80px)] flex flex-col justify-center overflow-hidden"
        >
            ...
            <div className="mx-auto w-full max-w-[1200px] flex flex-col lg:h-full lg:max-h-full">
                <div className="flex-none">
                    <div className="section-title font-serif text-[1.8rem] md:text-[2.2rem] font-light leading-none text-[#F5F0E8]">
                        Tạo nến của bạn
                    </div>
                    <div className="section-sub mt-1 text-[0.75rem] uppercase tracking-[0.08em] text-[#F5F0E8]/62">
                        Chọn từng thành phần
                    </div>
                </div>
                <div className="configurator mt-4 lg:mt-6 grid gap-4 rounded-2xl bg-[#2C1810] p-4 text-[#F5F0E8] shadow-[0_18px_50px_rgba(44,24,16,0.22)] md:grid-cols-2 md:p-5 lg:gap-8 lg:p-6 lg:flex-initial lg:max-h-[calc(100vh-180px)] h-fit">
                    <div className="config-panel flex flex-col gap-4 lg:overflow-y-auto lg:pr-3 scrollbar-custom lg:max-h-full">
                        <h3 className="text-[0.7rem] uppercase tracking-[0.15em] text-[#F5F0E8] font-semibold opacity-70">
                            Thành phần tùy chỉnh
                        </h3>
                        <div className="option-group">
                            <div className="option-label mb-1.5 text-[0.75rem] text-[#F5F0E8]/78">
                                Hương liệu
                            </div>
                                ...
                                {scentOptions.map((scent) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`opt scent-chip inline-flex items-center gap-1.5 rounded-lg border px-3 py-1.5 text-[0.75rem] tracking-[0.03em] transition ${active
                                                ? "border-[#6B1218] bg-[#6B1218] text-[#F5F0E8]"
                                                : "border-[#F5F0E8]/25 bg-transparent text-[#F5F0E8] hover:border-[#F5F0E8]"
                                                }`}
                                        >
                                            <span
                                                className="size-2 rounded-full bg-[#F5F0E8]/75 shadow-[0_0_10px_rgba(245,240,232,0.25)]"
                                            />
                                            {scent.name}
                                        </button>
                                    );
                        ...
                        <div className="option-group">
                            ...
                            <div className="color-opts flex flex-wrap gap-2.5" id="color-opts">
                                ...
                                {colorOptions.map((color) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`color-dot size-7 rounded-full border-2 shadow-[0_4px_10px_rgba(0,0,0,0.14)] transition hover:scale-110 ${active
                                ...
                                {sizeOptions.map((size) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`opt rounded-lg border px-3 py-1.5 text-[0.75rem] tracking-[0.03em] transition ${active
                                ...
                                {toppingOptions.map((topping) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`opt topping-chip inline-flex items-center gap-1 rounded-lg border px-3 py-1.5 text-[0.75rem] tracking-[0.03em] transition ${active
                                                ? "border-[#6B1218] bg-[#6B1218] text-[#F5F0E8]"
                                                : "border-[#F5F0E8]/25 bg-transparent text-[#F5F0E8] hover:border-[#F5F0E8]"
                                                }`}
                                        >
                                            <span className="topping-check w-3 text-center text-[0.6rem]">
                                                {active ? "☑" : "☐"}
                                            </span>
                                            {topping.name}
                    ...
                    <div className="flex flex-col lg:max-h-full lg:min-h-0 lg:self-start w-full">
                        <div className="preview-box flex flex-col rounded-2xl bg-[#F5F0E8] p-4 text-left text-[#2C1810] md:p-5 lg:p-5 lg:overflow-y-auto scrollbar-custom-dark lg:flex-initial h-fit">
                            <div
                                style={{ backgroundColor: selectedColorHex }}
                                className="mini-candle relative mx-auto mt-4 mb-2 h-[95px] w-[56px] rounded-[4px_4px_2px_2px] shadow-[inset_-6px_0_12px_rgba(0,0,0,0.1),inset_2px_0_6px_rgba(255,255,255,0.3),0_12px_26px_rgba(44,24,16,0.15)] transition"
                            >
                                <div className="custom-wick" />
                                <div className="custom-flame" />
                            </div>
                            <div
                                className="preview-name mt-2 font-serif text-[1.35rem] font-semibold text-[#6B1218] leading-tight"
                                id="prev-name"
                            >
                                {selectedScent?.name ?? "Chưa chọn hương"}
                            </div>
                            <div
                                className="preview-desc mb-2 text-[0.78rem] font-light italic text-[#8a6f5e]"
                                id="prev-desc"
                            >
                                {getScentDescription(selectedScent)}
                            </div>
                            <div className="preview-divider my-2 h-px w-full bg-[#6B1218]/15" />
                            <div className="preview-details w-full text-[0.78rem] leading-6 text-[#2C1810]">
                            ...
                            <div className="preview-toppings my-1 w-full" id="preview-toppings">
                                <div className="topping-list flex flex-wrap gap-1.5" id="topping-list">
                                    {selectedToppings.length === 0 ? (
                                        <div className="no-topping text-[0.78rem] italic text-[#a89080]">
                                            Chưa chọn topping
                                        </div>
                                    ) : (
                                        toppingOptions
                                            ...
                                            .map((topping) => (
                                                <span
                                                    key={topping.id}
                                                    className="topping-tag rounded-full bg-[#6B1218]/15 px-2.5 py-0.5 text-[0.72rem] font-medium text-[#6B1218]"
                                                >
                                                    {topping.name}
                                                </span>
                                            ))
                            ...
                            <div
                                className="preview-price-breakdown w-full pt-1.5 text-[0.78rem] text-[#2C1810]"
                                id="price-breakdown"
                            >
                                <div className="price-line flex justify-between gap-3 leading-5">
                                ...
                                {selectedSize ? (
                                    <div className="price-line flex justify-between gap-3 leading-5 text-[#2C1810]/65">
                                ...
                                <div className="price-total mt-2 flex justify-between gap-3 border-t border-[#6B1218]/20 pt-2 font-serif text-[1.2rem] font-semibold text-[#6B1218]">
                                    <span>Tổng:</span>
                                    <span id="price-display">{formatPrice(totalPrice)}</span>
                                </div>
                            </div>
                        </div>
                        <div className="price-row mt-4 flex flex-col gap-3 border-t border-[#F5F0E8]/20 pt-4 sm:flex-row sm:items-center sm:justify-between shrink-0">
                            <button
                                type="button"
                                onClick={handleAddToCart}
                                disabled={isAddingToCart}
                                className="add-btn w-full rounded-full bg-[#6B1218] px-6 py-3 text-[0.75rem] font-medium uppercase tracking-[0.1em] text-[#F5F0E8] shadow-[0_6px_20px_rgba(107,18,24,0.25)] transition hover:bg-[#4A0C10] hover:shadow-[0_10px_28px_rgba(107,18,24,0.4)] disabled:cursor-not-allowed disabled:opacity-65"
                            >
                                {isAddingToCart ? "Đang thêm..." : "Thêm vào giỏ"}
                            </button>
                            {cartError && (
                                <p className="mt-2 text-xs font-medium text-[#6B1218]">
                                    {cartError}
                                </p>
                            )}
                        </div>
