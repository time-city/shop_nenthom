    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col">
        <section className="flex min-h-0 flex-1 items-center justify-center px-4 py-4 sm:px-6 lg:px-8">
          <div className="animate-page-enter relative w-full max-w-[450px] rounded-[22px] border border-[#f5f0e8]/40 bg-[#F5F0E8]/95 px-5 py-6 text-[#2C1810] shadow-[0_24px_70px_rgba(0,0,0,0.55)] backdrop-blur-md sm:px-8 sm:py-8 opacity-0">
                      ...
                      <div className="flex justify-center gap-2 max-w-[320px] mx-auto mb-2">
                        {Array(6).fill(0).map((_, index) => (
                          <input
                            ...
                            className={`size-11 sm:size-12 rounded-xl border bg-white/80 text-center text-[1.22rem] font-bold text-[#2C1810] transition-colors focus:bg-white focus:border-[#7A1218] focus:outline-none focus:ring-4 focus:ring-[#6B1218]/10 ${
